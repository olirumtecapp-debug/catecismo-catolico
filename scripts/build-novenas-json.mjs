...
const novenas = [
  {
    id: "santa-teresinha",
    titulo: "Novena Milagrosa das Rosas de Santa Teresinha",
    subtitulo: "Doutora da Igreja e Padroeira das Missões",
    tipo: "fixa",
    padroeiro_de: "Missões Universais, Missionários, Vocações e Causas de Conversão",
    festa_liturgica: {
      dia: 1,
      mes: 10,
    ...
    instrucoes: "Esta novena comemora os 24 anos de Santa Teresinha na Terra. Reza-se tradicionalmente uma Oração Inicial, a Oração e Intenção do Dia, a oração milagrosa do Pe. Putigan e 24 Glórias ao Pai em agradecimento à Santíssima Trindade por todos os dons concedidos à santinha de Lisieux.",
    oracao_inicial: "Em nome do Pai, do Filho e do Espírito Santo. Amém.\n\nÓ Santa Teresinha do Menino Jesus, que na vossa curta existência fostes um espelho de angélica pureza, de amor forte e de tão generosa entrega a Deus, volvei vosso olhar de benevolência para mim que em vós confio. Vós que prometestes passar o vosso Céu fazendo o bem na terra, derramai sobre mim e sobre minhas dores uma chuva de rosas de bênçãos celestiais.",
    oracao_padrao_dia: "Santíssima Trindade, Pai, Filho e Espírito Santo, eu Vos agradeço todos os favores e todas as graças com que enriquecestes a alma de Vossa serva Santa Teresinha do Menino Jesus durante os vinte e quatro anos que passou na terra. E, pelos méritos de tão querida Santinha, concedei-me a graça que ardentemente Vos peço (faça o seu pedido)... se for conforme a Vossa santíssima vontade e para salvação de minha alma.",
    oracao_final: "Santa Teresinha do Menino Jesus, modelo de humildade, de confiança e de amor, do alto dos Céus deitai sobre nós uma chuva de rosas, para que possamos perseverar no amor de Deus e alcançar a eterna bem-aventurança. Glória ao Pai, ao Filho e ao Espírito Santo, como era no princípio, agora e sempre. Amém.",
    dias: [
      {
        dia: 1,
        tema: "A Pequena Via e a Confiança Filial",
        intencao: "Pela graça da total confiança na misericórdia e no amor do Pai Celeste.",
        reflexao: "Santa Teresinha descobriu que para ser santa não precisava de obras grandiosas aos olhos humanos, mas de fazer as menores coisas por amor imenso a Deus. É a 'Pequena Via': o abandono de uma criancinha nos braços de seu Pai.",
        oracao: "Ó Santa Teresinha, ensinai-me a simplicidade do coração. Afastai da minha vida o medo, o desespero e a vaidade, e ajudai-me a descansar nas mãos providentes de Deus, com a serenidade de uma criança que sabe que é profundamente amada."
      },
      {
        dia: 2,
        tema: "A Vocação para o Amor no Coração da Igreja",
        intencao: "Pela Santa Igreja Católica e pela renovação de nosso ardor pastoral.",
        reflexao: "'Minha vocação é o amor! No coração da Igreja, minha Mãe, serei o amor.' Teresinha compreendeu que a caridade é o coração pulsante do Corpo Místico de Cristo.",
        oracao: "Amada Santa Teresinha, concedei-me um coração ardente pela Igreja. Que em cada oração, sacrifício e palavra, eu manifeste a doçura e a verdade de Cristo, servindo ao próximo com sincera dedicação cristã."
      },
      {
        dia: 3,
        tema: "O Sorriso em Meio à Provação e Sofrimento",
        intencao: "Pela cura das dores físicas, emocionais e espirituais dos atribulados.",
        reflexao: "A tuberculose e a noite escura da fé nunca roubaram a paz interior de Teresinha. Ela aprendeu a acolher a cruz com gratidão, unindo seus padecimentos ao Santo Calvário de Jesus.",
        oracao: "Ó Santinha das Rosas, consolai os que choram e dai alívio aos enfermos. Diante das minhas próprias cruzes cotidianas, não permitais que eu me revolte, mas dai-me a virtude da paciência e o consolo do Espírito Santo."
      },
      {
        dia: 4,
        tema: "A Fidelidade nas Pequenas Coisas",
        intencao: "Pela perseverança e dignidade no trabalho e nas tarefas diárias.",
        reflexao: "Apanhar um alfinete do chão por amor a Deus tem mais valor eterno do que conquistar reinos sem caridade. É na rotina modesta que santificamos a nossa vocação.",
        oracao: "Santa Teresinha, livrai-me da preguiça e da negligência. Ajudai-me a cumprir com retidão e zelo todos os meus deveres familiares, profissionais e espirituais, oferecendo tudo a Deus com amor puro."
      },
      {
        dia: 5,
        tema: "O Zelo Apostólico e as Missões",
        intencao: "Por todos os missionários, sacerdotes e consagrados do mundo inteiro.",
        reflexao: "Sem nunca ter saído da clausura do Carmelo de Lisieux, Teresinha foi proclamada Padroeira Universal das Missões pela força de sua oração e de sua ardente intercessão pela salvação das almas.",
        oracao: "Ó celestial Padroeira das Missões, protegei os sacerdotes e catequistas da nossa Igreja. Que eles sejam santos, fiéis ao Evangelho e revestidos de coragem para anunciar Cristo a todas as nações."
      },
      {
        dia: 6,
        tema: "A Santa Comunhão e a Adoração Eucarística",
        intencao: "Pela reverência à Santíssima Eucaristia e frequência piedosa aos Sacramentos.",
        reflexao: "'Não é para ficar numa custódia de ouro que Ele desce todos os dias do Céu, mas para encontrar um outro céu: o céu de nossas almas.' Teresinha ansiava ardentemente pelo Pão da Vida.",
        oracao: "Concedei-me, Senhora e Doutora da Igreja, uma sede insaciável da Sagrada Eucaristia. Que eu jamais comungue indignamente e que meu coração se torne um tabernáculo puro e acolhedor para o Senhor Jesus."
      },
      {
        dia: 7,
        tema: "A Devoção Terna à Virgem Santíssima",
        intencao: "Pela consagração de nossas famílias ao Imaculado Coração de Maria.",
        reflexao: "Teresinha dizia com simplicidade: 'A Santíssima Virgem é mais Mãe do que Rainha.' Em sua infância, foi curada milagrosamente pelo maternal sorriso da Virgem Maria.",
        oracao: "Ó Teresinha, conduzi-me pelas mãos até os braços de Nossa Senhora. Ensinai-me a rezar o Santo Rosário com devoção sincera e a encontrar em Maria o refúgio seguro em todas as tempestades."
      },
      {
        dia: 8,
        tema: "A Promessa da Chuva de Rosas",
        intencao: "Pelas causas aparentemente sem saída e pelo alívio dos desesperados.",
        reflexao: "'Passarei o meu Céu a fazer bem sobre a terra. Uma chuva de rosas farei cair sobre o mundo até ao fim dos séculos.' Esta promessa é conforto perene para quem reza com fé.",
        oracao: "Santa Teresinha, olhai com piedade para as minhas angústias e necessidades prementes. Derramai a prometida chuva de graças e rosas em meu lar e na minha vida, obtendo de Deus a solução e a paz que tanto anseio."
      },
      {
        dia: 9,
        tema: "A Entrega Final: 'Meu Deus, eu Vos Amo!'",
        intencao: "Pela graça da santa perseverança até o último suspiro de vida.",
        reflexao: "As últimas palavras de Teresinha nesta terra selaram a sua existência terrena: 'Oh!... eu O amo!... Meu Deus... eu... Vos amo!'. Toda a sua vida foi um cântico ininterrupto de entrega filial.",
        oracao: "Gloriosa Santa Teresinha, neste nono dia em que concluo minha oração fervorosa, consagro-vos a minha vida e meus afetos. Alcançai-me a graça pedida nesta novena, mas sobretudo a graça soberana de amar a Deus até o meu último alento e cantar com os anjos Suas eternas misericórdias. Amém."
      }
    ]
  },
  {
